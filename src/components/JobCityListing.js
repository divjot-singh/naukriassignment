        ...
        return(
            <div className="citylisting">
                <div className="joblistingheader">
                    <img src="assets/icons/Jobs by Location.svg" alt="Location Icon" className="joblistingicon" height="35" width="35"></img>
                                    ...
                                    return Object.keys(value.joblocation).map( (key,index) => {
                                        ...
                                        return (
                                                    <div className="listcontainer" key={key}>
                                                        <img src={src} height="100" width="100" alt={key}></img>
